...
demoApp.controller('DemoCtrl', ['$scope', 'StepsService', function($scope, StepsService) {
        $scope.students = [];
        $scope.countDown0 = 60;
        $scope.countDown01 = 30;
        $scope.countDown02 = 30;
        $scope.countDown03 = 60;
        $scope.countDown04 = 30;
        $scope.countDown05 = 60;
        $scope.countDown06 = 60;
        $scope.countDown07 = 30;
        $scope.countDown08 = 30;
        $scope.countDown09 = 30;
        $scope.countDown010 = 60; 
        $scope.countDown011 = 20;
        $scope.countDown012 = 20;
        $scope.countDown013 = 20;
        $scope.countDown014 = 20;
        $scope.countDown015 = 20;
        ...
        $scope.fetch10 = function() {
            ...
            $scope.handlecheck = function(getValue)
            {
                console.log(getValue);
            }
            function handlecheck(getValue)
            {
            console.log(getValue)
            }
            function exitHandler() {
